...
with open(r'C:\Users\wdarr\PycharmProjects\2020GaSTCResults\data\us_counties.json') as us_counties_file:
...
with open(r'C:\Users\wdarr\PycharmProjects\2020GaSTCResults\data\ga_counties.json', 'w') as ga_counties_file:
